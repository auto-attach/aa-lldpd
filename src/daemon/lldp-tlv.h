...
#define LLDP_TLV_AVAYA_FA_ISID_VLAN_DIGEST_LENGTH	32
#define LLDP_TLV_AVAYA_FA_ELEM_TYPE_UNKNOWN		1
#define LLDP_TLV_AVAYA_FA_ELEM_TYPE_SERVER		2
#define LLDP_TLV_AVAYA_FA_ELEM_TYPE_PROXY		3
#define LLDP_TLV_AVAYA_FA_ELEM_TYPE_UNTAG_CLIENT	4
#define LLDP_TLV_AVAYA_FA_ELEM_TYPE_TAG_CLIENT		5
#define LLDP_TLV_AVAYA_FA_ELEM_TYPE_SERV_NO_AUTH	6
#define LLDP_TLV_AVAYA_FA_ELEM_TYPE_PROXY_NO_AUTH	7
#define LLDP_TLV_AVAYA_FA_ELEM_CONN_TYPE_SINGLE		0
#define LLDP_TLV_AVAYA_FA_ELEM_CONN_TYPE_MLT		1
#define LLDP_TLV_AVAYA_FA_ELEM_CONN_TYPE_SLT		2
#define LLDP_TLV_AVAYA_FA_ELEM_CONN_TYPE_SMLT		3
